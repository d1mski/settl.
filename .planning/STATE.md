...
last_updated: "2026-06-24T14:10:22.677Z"
progress:
  total_phases: 10
  completed_phases: 10
  total_plans: 25
...
- [Phase 10 post-UAT enhancements] (commits a0e4fbb, 157e8a9, d5576e7, 53170b9, 9f4b323 — not in any plan SUMMARY): On 5/10y, hide hourly/UV-dependent sections (Thermal Matrix, Humidity, UV, Peak UV) entirely instead of N/A boxes; add monthly avg-high/avg-low TEMPERATURE RANGE band chart (new avgHigh/avgLow on MonthlyAggregate) + avg high/low in readout. YearSelector extracted to src/components/hud/YearSelector.tsx and added to Overview (ReportPanel) above headline. Overview climate cards recompute from useClimateArchive on 5/10y (climate cards only — Wind/Sun/severity stay on 1yr useOpenMeteo, scope guard held). Period-aware copy: "ANNUAL READOUT"→"{N}-YEAR READOUT", Overview subhead "{N}-year averages". UV genuinely unavailable from ERA5 archive (all-null) — permanently N/A on multi-year. All human-verified live.
