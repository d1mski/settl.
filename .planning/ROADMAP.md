...
- [ ] 10-02-PLAN.md — Climate archive layer: useClimateArchive (ERA5 daily, sum÷N normalize) + useOpenMeteo KEY_VERSION v8 + years param [DATA-04]
...
| 10. Marine + Climate Selector | 1/4 | In Progress|  |
