...
function deriveOne(data: ClimateData | null): Derived | null {
  ...
  return {
    data,
    rose: buildWindRose(data.hourly.windSpeed10m, data.hourly.windDirection10m),
...
function SingleView({ d }: { d: Derived }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <Section code="01" title="WIND ROSE" subtitle="16 SECTORS · 5 SPEED BINS · 12 MO">
      ...
      <Section code="02" title="MONTHLY VELOCITY" subtitle="MEAN + GUST · KM/H">
...
function CompareView({ a, b }: { a: Derived; b: Derived }) {
  ...
  return (
    <div className="space-y-5">
      <Section code="01" title="WIND ROSE" subtitle="A | B · 16 SECTORS · 12 MO">
      ...
      <Section code="02" title="WIND READOUT" subtitle="A ↔ B">
